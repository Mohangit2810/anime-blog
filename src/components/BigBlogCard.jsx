    ...
    <article className="flex flex-col items-center justify-center gap-8 rounded-lg px-3 py-4 bg-white">
      <div className="shrink-0 relative overflow-hidden">
        <img
          ...
          alt="mwew"
        />
        <span className="absolute top-6 -left-5 bg-[#0077b5] text-white text-sm rounded-full py-2 pl-12 pr-8 transition-all duration-300 ease-in-out hover:-left-2">
          LifeStyle
        </span>
      </div>
      ...
      <ul className="flex items-center gap-6">
        ...
        <li className="flex items-center text-center">
          ...
          <div className="flex gap-2 ml-3">
            <svg
              className="w-4 h-4 fill-orange-300"
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
              width="100"
      ...
      <p className="tracking-wider leading-relaxed text-center px-24">
        The Anime which made the Cute Girls Doing Cute Things Genre popular, The
        K-On should be in your watchlist not only because the anime is cute ,
        ...
      </p>
      <div className="flex items-center justify-between gap-24 my-2">
        <ul className="flex gap-4">
          <li className="relative tags pl-4 font-medium before:bg-[#0077b5]">
            CGDCT
          </li>
          <li className="relative tags pl-4 font-medium before:bg-accent">
            Slice of Life
          </li>
        </ul>
        <div className="flex gap-2 items-center">
          <img className="w-6 h-6 rounded-full" src="/hero.jpg" alt="nuu" />
          <p className="hover:text-accent text-sm">MohanRaji</p>
        </div>
      </div>
    </article>
  );
