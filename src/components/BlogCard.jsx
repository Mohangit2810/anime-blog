    ...
    <article className="flex gap-12 rounded-lg px-3 py-4 bg-white h-80">
      <div className="shrink-0 relative overflow-hidden">
        <img
          ...
          alt="mwew"
        />
        <span className="absolute top-6 -left-5 bg-[#0077b5] text-white text-sm rounded-full py-2 pl-12 pr-8 transition-all duration-300 ease-in-out hover:-left-3">
          LifeStyle
        </span>
      </div>
      <div className="flex flex-col gap-6 pr-8">
        ...
        <p className="tracking-wider leading-relaxed">
          The Anime which made the Cute Girls Doing Cute Things Genre popular,
          The K-On should be in your watchlist not only because the anime is
          cute , ...
        </p>
