    ...
    <div>
      ...
      <div className="mx-52">
        <h1 className="text-4xl font-bold text-center mt-12 mb-8">
          ...
          <svg
            className="w-12 h-12 fill-accent inline ml-2"
        ...
        <p className="text-base text-center mx-56 leading-relaxed tracking-wider">
          Whether you&apos;re a photography aficionado or simply intrigued by
          the art of visual storytelling, our blog is your gateway to exploring
          the mesmerizing world of renowned photographers and the captivating
          narratives.
        </p>
      </div>
    </div>
