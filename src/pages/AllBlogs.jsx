...
function AllBlogs() {
  ...
  return (
    <div>
      <Header />
      <div className=" mx-2 xs:mx-6 md:mx-12 xl:!mx-44">
        <h1 className=" text-2xl md:text-4xl font-bold text-center my-12 md:my-24">
          Explore Our Blogs
          <svg
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 xl:!gap-12 mb-12 ">
