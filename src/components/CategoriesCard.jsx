...
function CategoriesCard() {
  return (
    <div className="mx-12 xl:mx-52">
      ...
      <p className="text-base text-center mx-12 xl:mx-56 leading-relaxed tracking-wider">
      ...
      <ul className="my-12 xl:my-20 bg-white rounded grid grid-cols-4 py-12 pl-16 gap-y-8">
