...
function CategoriesCard() {
  return (
    <div className="mx-4 md:mx-12 xl:!mx-52">
      ...
      <p className="text-base text-justify md:text-center mx-4 md:mx-12 xl:!mx-56 md:leading-relaxed tracking-wide">
      ...
      <ul className="my-12 xl:!my-20 bg-white rounded grid grid-cols-1 xs:grid-cols-2 md:!grid-cols-4 py-4 md:py-12 pl-6 md:pl-16 gap-y-8">
